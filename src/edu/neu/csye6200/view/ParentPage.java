...
public class ParentPage extends JPanel{
    /**
     * component
     */
    ...
    private JButton cancelRegistrationJButton = new JButton("Cancel Your Registration For Our School");
    ...
    private void createMiddlePanel () {
        ...
        middleJPanel.add(cancelRegistrationJButton);
        middleJPanel.add(Box.createVerticalStrut(10));
